        ...
        for i in range(0, P):
            ...
            for j in range(i, P):
                if filter_index < len(filter_list):
                    ...
                    filter_index += 1
        return torch.tensor(weight_np)

class mWDN(nn.Module):
    def __init__(self, args, wavelet=None, arch=InceptionTime, arch_kwargs={}):
        super(mWDN, self).__init__()
        c_in, c_out, seq_len, levels = args.c_in, args.c_out, args.seq_len, args.levels
        self.levels=levels
